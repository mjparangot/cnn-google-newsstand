                        ...
                        if (item.location === 'pageTop') {
                            ...
                            if (item.type === 'reference') {
                                ...
                                if (item.referenceType === 'video') {
                                    ...
                                    feed += `<media:content url="${item.cdnUrls['640x360_900k_mp4']}" width="640" height="360" medium="video">`;
                                ...
                                if (paragraph.elements[0].target.type === 'video') {
                                    contentModel.docs[0].relatedMedia.media.some((item) => {
                                        if (item.location === paragraph.id && item.cuts) {
                                            ...
                                            feed += `<video width="640" height="360" src="${item.cdnUrls['640x360_900k_mp4']}" poster="${item.cuts[imageCut].url.replace(/i2.cdn.turner.com\/cnnnext\/dam\/assets\//, 'dynaimage.cdn.turner.com/gns/gns/e_trim/').replace(/\-super\-169/, '').replace(/-live-video/, '')}"></video>`;
